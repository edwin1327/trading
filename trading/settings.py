...
SECRET_KEY = 'django-insecure-agum6*jw(ns0ctq$o)!%ad-pjrxswsh8e6c6!$c%(6!)ddkzyb'
...
# VARIABLES PARA USO DE CRISPY-BOOTSTRAP5
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'templates'), # Carpeta de plantillas en la raíz del proyecto
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
